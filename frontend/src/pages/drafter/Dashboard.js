    ...
    <Layout>
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Daftar Proyek Perencanaan</CardTitle>
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="completed">Finish</SelectItem>
              ...
              <table className="w-full">
                <thead className="border-b">
                  <tr className="text-left text-sm text-slate-600">
                    ...
                    <th className="pb-3 font-semibold text-right">Nilai Proyek</th>
                    <th className="pb-3 font-semibold">Status</th>
                    <th className="pb-3 font-semibold">Mulai</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <tr key={project.id} className="border-b hover:bg-slate-50">
                        ...
                        <td className="py-3">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                            ...
                            {project.type === 'interior' ? 'Interior' : 'Arsitektur'}
                          </span>
                        </td>
                        <td className="py-3 text-sm text-slate-600">{project.location || '-'}</td>
                        ...
                        <td className="py-3 text-sm text-slate-600">{formatDate(project.created_at)}</td>
                      </tr>
                    ))
                  )}
                </tbody>
