...
import { Plus, Edit, Trash2, MoreVertical, FileText, CheckCircle, Clock, XCircle, Search } from 'lucide-react';
...
const RABList = () => {
  ...
  const filterRABs = () => {
    ...
    // Sort by status priority and created_at
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-600 mt-1">Kelola Rencana Anggaran Biaya proyek</p>
          </div>
              ...
              <table className="w-full">
                <thead className="border-b">
                  <tr className="text-left text-sm text-slate-600">
                    ...
                    <th className="pb-3 font-semibold">Pembuat</th>
                  ...
                  {filteredRabs.length === 0 ? (
                    ...
                    filteredRabs.map((rab) => (
                      <tr key={rab.id} className="border-b hover:bg-slate-50">
                        ...
                        <td className="py-3 text-sm text-slate-600">{rab.created_by || '-'}</td>
